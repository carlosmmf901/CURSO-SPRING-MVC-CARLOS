package com.gereciamentoEstoque.gerenciamentoEstoque.configuration;
...
public class DataConfiguration {
    ...
    public DataSource dataSource(){
		...
		dataSource.setUrl("jdbc:mysql://localhost:3306/db_curso_produtos?useTimezone=true&serverTimezone=UTC");
        //Usuario e senha
